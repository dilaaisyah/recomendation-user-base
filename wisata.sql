...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2016 at 02:13 PM
...
(1, 'GreatAdmin', 'admin@la.fr', '$2y$10$l8EYCuAr4t5F/QNNr5NTxOIW.AfZL9zggwZb5VFXdJGP92Hl312dO', 1, 1, 1, 1, NULL, '2016-03-13 03:14:44', '2016-03-25 08:33:06', 'ROlJhkTtEfc8zk5IvAy2SrOyv3bOWsEli8O5xjdFun7QFJMrhkhqRF9QoK8R'),
(2, 'GreatRedactor', 'redac@la.fr', '$2y$10$ygjhkR2ApavKRjKWvlzGPOcgwkMLKSl0N.SOUK9TFAHhYlX6lhRg2', 2, 1, 1, 1, NULL, '2016-03-13 03:14:44', '2016-03-25 08:32:34', 'lARj2nJNqgWAZ1joERKFA7r4s5ko3I1oHpxsZo5ABswRZZ80rEmnz7S5AAFL'),
(3, 'Walker', 'walker@la.fr', '$2y$10$YaF1ozDqL6Snjh7B2f/bEeOHM6maccvhC6fUp9Yh7lH/oEFBmm.je', 3, 0, 0, 1, NULL, '2016-03-13 03:14:44', '2016-03-22 05:46:19', 'ZSYvMUwkRwLIOUgWwVJu7wusJwvLhnVn69X2S0RUuf1DzRWQNFmGTaVIXVHj'),
...
--
ALTER TABLE `posts`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `posts_slug_unique` (`slug`), ADD KEY `posts_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `users_username_unique` (`username`), ADD UNIQUE KEY `users_email_unique` (`email`), ADD KEY `users_role_id_foreign` (`role_id`);
