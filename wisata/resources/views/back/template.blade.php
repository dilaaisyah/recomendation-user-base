        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    @if(session('statut') == 'admin')   
                    <li {!! classActiveSegment(1, 'slider') !!}>
                        <a href="#" data-toggle="collapse" data-target="#slidermenu"><span class="fa fa-fw fa-picture-o"></span> Slider <span class="fa fa-fw fa-caret-down"></a>
                        <ul id="slidermenu" class="collapse">
                            <li><a href="{!! url('slider') !!}">{{ trans('back/admin.see-all') }}</a></li>
                            <li><a href="{!! url('slider/create') !!}">{{ trans('back/admin.add') }}</a></li>
                        </ul>
                    </li>
                    @endif
                </ul>
