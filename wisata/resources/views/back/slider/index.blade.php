...
@section('main')
  ...
  @include('back.partials.entete', ['title' => 'Slider / Advertise' . link_to_route('slider.create', trans('back/blog.add'), [], ['class' => 'btn btn-info pull-right']), 'icone' => 'pencil', 'fil' => trans('back/blog.posts')])
  ...
  <script>
    ...
    $(function() {
      ...
      $(document).on('change', ':checkbox[name="active"]', function() {
        ...
        var token = $('input[name="_token"]').val();
        $.ajax({
          url: '{{ url('slideractive') }}' + '/' + this.value,
          type: 'PUT',
